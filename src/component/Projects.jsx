      ...
      <div className="mx-auto px-4 py-10 md:py-20 w-full md:w-4/5">
        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 backdrop-blur-md">
          {projects.map((project, index) => (
            <div
              key={index}
              className=" bg-slate-950 rounded-md shadow-xl border-2 overflow-hidden hover:cursor-pointer transition-all duration-300 transform hover:scale-100 border-teal-500 hover:border-2 h-[300px] relative group"
            >
              ...
              <div className="details-container p-4 group-hover:h-[320px] h-60 transition-all duration-30">
                <h2 className="text-white text-xl font-bold mb-2 ">
                  {project.title}
                </h2>
                <p className="text-white mb-2 group-hover:opacity-100 opacity-0 transition-opacity duration-300 ">
                  {project.description}
                </p>
