...
const Service = () => {
  ...
  {/* Web Development */}
  <div className="relative text-white shadow-lg border-2 rounded-lg backdrop-blur-md hover:scale-105 transition-transform duration-300 p-4 bg-blue-500 cursor-pointer group" data-aos="fade-down">
  ...
  {/* ReactJS Support */}
  <div className="relative shadow-lg border-2 rounded-lg backdrop-blur-md hover:scale-105 transition-transform duration-300 p-4 bg-green-500 cursor-pointer group"data-aos="fade-up">
  ...
  {/* Online Help */}
  <div className="relative shadow-lg border-2 rounded-lg backdrop-blur-md hover:scale-105 transition-transform duration-300 p-4 bg-purple-500 cursor-pointer group" data-aos="fade-down">
  ...
  {/* Technical Support */}
  <div className="relative shadow-lg border-2 rounded-lg backdrop-blur-md hover:scale-105 transition-transform duration-300 p-4 bg-red-500 cursor-pointer group" data-aos="fade-up">
